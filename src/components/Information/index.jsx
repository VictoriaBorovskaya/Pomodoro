    ...
    return(
        <div className={isOpen ? "bg-neutral-900/75 fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center" : "hidden"} onClick={() => setIsOpen(false)}>
            <div className="max-w-3xl m-auto bg-white p-8 relative max-h-full overflow-auto" onClick={closeModal}>
                ...
                <h1 className="text-2xl sm:text-4xl font-bold text-red-900 py-5 text-center">Oнлайн-таймер для повышения вашей продуктивности</h1>
                <p className="text-xl sm:text-3xl font-bold text-red-600 py-3">Что такое Pomodoro?</p>
                <p className="text-base sm:text-lg text-justify">Цель этого приложения — помочь вам сосредоточиться на любой задаче, над которой вы работаете, например, на учебе, письме или программировании. 
                ...
                <p className="text-xl sm:text-3xl font-bold text-red-600 py-3">Что такое техника Pomodoro?</p>
                <p className="text-base sm:text-lg text-justify">Техника помидора создана Франческо Чирилло для более продуктивного способа работы и учебы. 
                ...
                <p className="text-xl sm:text-3xl font-bold text-red-600 py-3">Как использовать таймер Pomodoro?</p>
                <div className="text-base sm:text-lg pb-5 text-justify">
